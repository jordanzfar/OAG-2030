        ...
        <div className="space-y-6">
            ...
            <Card className="bg-card border-border shadow-lg">
                    <CardHeader>
                        ...
                        <CardDescription>Estado de tus solicitudes y descarga de reportes completados.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        {historyLoading ? (
                            ...
                            <div className="space-y-4">
                                {vinHistory.map((check) => (
                                    <div key={check.id} className="p-4 border rounded-lg bg-background hover:bg-secondary/80 transition-colors">
                                        <div className="flex justify-between items-start gap-4">
                                            <div className="flex-grow">
                                                <h4 className="font-semibold font-mono text-base text-foreground break-all">{check.vin}</h4>
                                                <p className="text-sm text-muted-foreground">
                                                    Solicitado: {new Date(check.created_at).toLocaleDateString('es-ES', { day: 'numeric', month: 'long', year: 'numeric' })}
                                                </p>
                                            </div>
                                        ...
                                        {/* ====== INICIO: Lógica para el botón de descarga (MEJORADA) ====== */}
                            ...
                            <p className="text-center text-muted-foreground italic py-4">No hay verificaciones anteriores registradas.</p>
                        )}
                    </CardContent>
                </Card>
