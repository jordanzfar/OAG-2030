...
var $57acba87d6e25586$var$ScrollAreaScrollbarVisible = (0, import_react9.forwardRef)((props, forwardedRef) => {
  ...
  if (orientation === "horizontal") return (0, import_react9.createElement)($57acba87d6e25586$var$ScrollAreaScrollbarX, _extends({}, commonProps, {
    ref: forwardedRef,
  ...
  if (orientation === "vertical") return (0, import_react9.createElement)($57acba87d6e25586$var$ScrollAreaScrollbarY, _extends({}, commonProps, {
    ref: forwardedRef,
    onThumbPositionChange: () => {
      if (context.viewport && thumbRef.current) {
